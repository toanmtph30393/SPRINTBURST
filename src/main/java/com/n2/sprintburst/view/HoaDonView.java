...
import com.n2.sprintburst.repository.HoaDonChiTietRepository;
import com.n2.sprintburst.repository.HoaDonRepository;
...
>>>>>>> ab1b8049a7509197e5a33dde5075f82531b6e7e5
    ...
    private void showTableHoaDonChiTiet(ArrayList<HoaDonChiTietResponse> lists) {
        ...
        lists.forEach(s -> dtmHoaDonChiTiet.addRow(new Object[]{
            index.getAndIncrement(), s.getId(), s.getHoaDon(), s.getSanPhamChiTiet(),
